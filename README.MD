# Khushi Tyagi - Portfolio Website for a Full Stack Developer

Welcome to **My Portfolio**! This is my personal portfolio for showcasing my skills, projects, experience, education, certifications, and more. It’s built using React, TypeScript, Tailwind CSS, and other modern web technologies. It fetches data from various APIs to display the latest information, such as projects, LeetCode submissions. The portfolio is responsive, interactive, and optimized for performance.
...
- **Email**: [tyagikhushi161@gmail.com](mailto:tyagikhushi161@gmail.com)
- **LinkedIn**: [linkedin.com/in/khushityagi208](https://linkedin.com/in/khushityagi0208)

---

### 🔥 Made with ❤️ by **KhushiTyagi**